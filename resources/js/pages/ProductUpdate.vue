...
export default {
    ...
    methods: {
        ...
        formSubmitUpdate(e) {
            ...
            // fetch(`http://127.0.0.1:8000/api/products/update/${this.$route.params.id}`, {
            //     method: 'PUT',
            //     config,
            //     body: formData
            // })
            ...
            axios.put(`http://127.0.0.1:8000/api/products/update/${this.$route.params.id}`, formData, config)
                .then(res => {
                    console.log(res)
                })
        }
